...
4. {#continue} Run </a> the development server by this command `"python manage.py runserver"`.
...
Url shortener application includes [unit test](url_shortener/tests.py), such as, tests for creating and redirecting a short URL and
